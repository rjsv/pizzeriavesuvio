...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'caverta' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'caverta' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'caverta' ),
			'200'       => esc_html__( 'Light 200', 'caverta' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'caverta' ),
			'300'       => esc_html__( 'Book 300', 'caverta' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'caverta' ),
			'400'       => esc_html__( 'Normal 400', 'caverta' ),
			'regular'   => esc_html__( 'Normal 400', 'caverta' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'caverta' ),
			'500'       => esc_html__( 'Medium 500', 'caverta' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'caverta' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'caverta' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'caverta' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'caverta' ),
			'700'       => esc_html__( 'Bold 700', 'caverta' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'caverta' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'caverta' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'caverta' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'caverta' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'caverta' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'caverta' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'caverta' ),
		);
	}

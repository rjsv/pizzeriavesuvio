	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'caverta' ),
				'remove'               => esc_html__( 'Remove', 'caverta' ),
				'default'              => esc_html__( 'Default', 'caverta' ),
				'selectFile'           => esc_html__( 'Select File', 'caverta' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'caverta' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'caverta' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'caverta' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'caverta' ),
			)
		);

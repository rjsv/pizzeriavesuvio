...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'caverta' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'caverta' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'caverta' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'caverta' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'caverta' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'caverta' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'caverta' ); ?>',
} );
#>

...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'caverta' ),
				'change'       => esc_html__( 'Change image', 'caverta' ),
				'default'      => esc_html__( 'Default', 'caverta' ),
				'remove'       => esc_html__( 'Remove', 'caverta' ),
				'placeholder'  => esc_html__( 'No image selected', 'caverta' ),
				'frame_title'  => esc_html__( 'Select image', 'caverta' ),
				'frame_button' => esc_html__( 'Choose image', 'caverta' ),
			)
		);
	}
